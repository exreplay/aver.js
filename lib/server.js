...
export default class Server {
    ...
    initRenderer() {
        ...
        if (this.isProd) {
            ...
            this.readyPromise = require(path.resolve(require.resolve('vue-ssr-renderer'), '../webpack/setup-dev-server'))(this.app, (bundle, options) => {
    ...
    render(req, res) {
        ...
        if (typeof req.isAuthenticated === 'function') Object.assign(context, { isAuthenticated: req.isAuthenticated() });
