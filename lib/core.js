    ...
    init() {
        ...
        if (fs.existsSync(process.env.PROJECT_PATH)) {
            ...
            ncp(path.resolve(appDir, './src'), process.env.PROJECT_PATH, (err) => {
                ...
                fs.copyFileSync(path.resolve(appDir, './.babelrc'), path.resolve(process.env.PROJECT_PATH, '../.babelrc'));
                ...
                fs.copyFileSync(path.resolve(appDir, './docker-compose.example.yml'), path.resolve(process.env.PROJECT_PATH, '../docker-compose.yml'));
